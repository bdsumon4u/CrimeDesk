...
new class extends Component
{
    ...
    {
        if (str($this->phone)->startsWith('01')) {
        ...
        return array_merge(
            ...
            ['phone' => 'required|regex:/^\+8801\d{9}$/|unique:users'],
...
<x-auth::layouts.app title="{{ config('devdojo.auth.language.register.page_title') }}">
    ...
    <x-auth::elements.container>
        ...
        <form wire:submit="register" class="space-y-5">
            ...
            <x-auth::elements.input label="Phone number" id="phone" name="phone" type="phone" wire:model="phone" data-auth="phone-input" autocomplete="phone" required />
